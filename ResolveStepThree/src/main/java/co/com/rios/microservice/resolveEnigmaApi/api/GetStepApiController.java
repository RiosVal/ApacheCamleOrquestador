...
public class GetStepApiController implements GetStepApi {
    ...
    @EndpointInject(uri="direct:get-step-three")
    ...
    public ResponseEntity<?> getStepString(){
    	return new ResponseEntity<>("Step 3: Close the refrigerator", HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<JsonApiBodyResponseSuccess>> getStepPost(@ApiParam(value = "Get one enigma step API" ,required=true )  @Valid @RequestBody JsonApiBodyRequest body) {
        ...
        String respuesta = "Step 3: Close the refrigerator";
        
        if (!pasoEnigma.equals("3")) {
        	respuesta = "Paso incorrecto para el servicio";
        } 
