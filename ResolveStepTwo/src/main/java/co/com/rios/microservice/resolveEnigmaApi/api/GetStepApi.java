...
public interface GetStepApi {
    ...
    @ApiOperation(value = "Get one engima step API", nickname = "getStepPost", notes = "", response = JsonApiBodyResponseSuccess.class, responseContainer = "List", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "search results matching criteria", response = JsonApiBodyResponseSuccess.class, responseContainer = "List"),
        @ApiResponse(code = 424, message = "bad input parameter", response = JsonApiBodyResponseErrors.class, responseContainer = "List") })
    @RequestMapping(value = "/getStepPost",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<List<JsonApiBodyResponseSuccess>> getStepPost(@ApiParam(value = "Get multiple enigma steps API" ,required=true )  @Valid @RequestBody JsonApiBodyRequest body);
}
